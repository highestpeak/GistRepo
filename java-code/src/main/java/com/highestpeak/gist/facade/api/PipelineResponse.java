...
import com.highestpeak.gist.common.help.JedisDataException;
...
public class PipelineResponse<T> {
    ...
    private Object data;
    private PipelineResponse<?> dependency = null;

    public PipelineResponse(Builder<T> b) {
        this.builder = b;
    }
    ...
    public void setDependency(PipelineResponse<?> dependency) {
